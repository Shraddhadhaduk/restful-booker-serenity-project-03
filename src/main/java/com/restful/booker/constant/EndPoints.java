...
public class EndPoints {
    ...
    public static final String CREATE_BOOKING_IDS = "/booking";
    ...
    public static final String PARTIAL_UPDATE_BOOKING_BY_ID = "/booking/{bookingId}";
    public static final String DELETE_USER_BY_ID = "/booking/{bookingId}";
}
